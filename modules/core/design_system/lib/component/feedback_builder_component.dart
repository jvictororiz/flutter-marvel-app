...
class ScreenBuilderComponent extends StatelessWidget {
  ...
  const ScreenBuilderComponent(
      {Key? key, this.loadingWidget, this.errorWidget, this.successWidget, this.emptyWidget, required this.isLoading, required this.isError, required this.isSuccess, this.isEmpty})
      : super(key: key);
